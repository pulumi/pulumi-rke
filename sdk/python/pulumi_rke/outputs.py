...
class ClusterAuthorization(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, Any] options: RKE options for authorization (map)
        """
        if mode is not None:
...
class ClusterBastionHost(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str address: Address of Bastion Host (string)
        :param str user: SSH User to Bastion Host (string)
        :param bool ignore_proxy_env_vars: Ignore proxy env vars at Bastion Host? Default: `false` (bool)
        :param str port: SSH Port of Bastion Host. Default `22` (string)
        :param bool ssh_agent_auth: SSH Agent Auth enable (bool)
        :param str ssh_cert: SSH Certificate Key (string)
...
class ClusterCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str key: Use service instead
        :param str name: Cloud Provider name. `aws`, `azure`, `custom`, `external`, `openstack`, `vsphere` are supported (string)
...
class ClusterCloudProviderAwsCloudConfigGlobal(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str subnet_id: Enables using a specific subnet to use for ELB's (string)
...
class ClusterDns(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ClusterDnsNodelocalArgs' nodelocal: Nodelocal dns config  (list Maxitem: 1)
        :param str provider: DNS provider. `kube-dns`, `coredns` (default), and `none` are supported (string)
...
class ClusterIngress(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, Any] extra_args: Extra arguments for the ingress controller (map)
...
class ClusterNetworkCanalNetworkProvider(dict):
    def __init__(__self__, *,
        ...
        """
        :param str iface: Canal network interface (string)
        """
...
class ClusterRunningSystemImage(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str etcd: Etcd options for RKE services (list maxitems:1)
        ...
        :param str nodelocal: Nodelocal dns config  (list Maxitem: 1)
...
class ClusterServices(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'ClusterServicesEtcdArgs' etcd: Etcd options for RKE services (list maxitems:1)
...
class ClusterServicesEtcdBackupConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param bool enabled: Enable etcd backup. Default `true` (bool)
        ...
        :param int timeout: Timeout in seconds for etcd backup. Default: `300`. Just for RKE v1.2.6 and above (int)
        """
...
class ClusterServicesKubeApi(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str service_cluster_ip_range: Service Cluster IP Range option for kube API service (string)
...
class ClusterServicesKubeApiAuditLog(dict):
    def __init__(__self__, *,
                 ...
                 enabled: Optional[bool] = None):
        """
        :param 'ClusterServicesKubeApiAuditLogConfigurationArgs' configuration: Audit log configuration. (list maxtiem: 1)
        :param bool enabled: Enable etcd backup. Default `true` (bool)
        """
...
class ClusterServicesKubeApiDeprecatedAuditLog(dict):
    def __init__(__self__, *,
                 ...
                 enabled: Optional[bool] = None):
        """
        :param 'ClusterServicesKubeApiDeprecatedAuditLogConfigurationArgs' configuration: Audit log configuration. (list maxtiem: 1)
        :param bool enabled: Enable etcd backup. Default `true` (bool)
        """
        if configuration is not None:
            pulumi.set(__self__, "configuration", configuration)
...
class ClusterServicesKubeApiDeprecatedEventRateLimit(dict):
    def __init__(__self__, *,
                 ...
                 enabled: Optional[bool] = None):
        """
        :param str configuration: Audit log configuration. (list maxtiem: 1)
        :param bool enabled: Enable etcd backup. Default `true` (bool)
        """
        if configuration is not None:
            pulumi.set(__self__, "configuration", configuration)
