...
import com.pulumi.rke.outputs.ClusterServicesEtcdBackupConfigS3BackupConfig;
...
public final class ClusterServicesEtcdBackupConfig {
     ...
     * 
     */
    private @Nullable ClusterServicesEtcdBackupConfigS3BackupConfig s3BackupConfig;
    /**
     ...
     * 
     */
    public Optional<ClusterServicesEtcdBackupConfigS3BackupConfig> s3BackupConfig() {
    ...
    public static Builder builder(ClusterServicesEtcdBackupConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer timeout;
        public Builder() {}
        public Builder(ClusterServicesEtcdBackupConfig defaults) {
        ...
        @CustomType.Setter
        public Builder s3BackupConfig(@Nullable ClusterServicesEtcdBackupConfigS3BackupConfig s3BackupConfig) {
        ...
        public ClusterServicesEtcdBackupConfig build() {
            final var _resultValue = new ClusterServicesEtcdBackupConfig();
