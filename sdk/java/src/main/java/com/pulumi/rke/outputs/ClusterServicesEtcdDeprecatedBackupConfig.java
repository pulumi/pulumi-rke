...
import com.pulumi.rke.outputs.ClusterServicesEtcdDeprecatedBackupConfigS3BackupConfig;
...
@CustomType
public final class ClusterServicesEtcdDeprecatedBackupConfig {
    /**
     ...
     * 
     */
    private @Nullable ClusterServicesEtcdDeprecatedBackupConfigS3BackupConfig s3BackupConfig;
    /**
     ...
     * 
     */
    public Optional<ClusterServicesEtcdDeprecatedBackupConfigS3BackupConfig> s3BackupConfig() {
    ...
    public static Builder builder(ClusterServicesEtcdDeprecatedBackupConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer timeout;
        public Builder() {}
        public Builder(ClusterServicesEtcdDeprecatedBackupConfig defaults) {
        ...
        @CustomType.Setter
        public Builder s3BackupConfig(@Nullable ClusterServicesEtcdDeprecatedBackupConfigS3BackupConfig s3BackupConfig) {
        ...
        public ClusterServicesEtcdDeprecatedBackupConfig build() {
            final var _resultValue = new ClusterServicesEtcdDeprecatedBackupConfig();
