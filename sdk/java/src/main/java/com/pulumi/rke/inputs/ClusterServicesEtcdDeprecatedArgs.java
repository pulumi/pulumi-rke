...
import com.pulumi.rke.inputs.ClusterServicesEtcdDeprecatedBackupConfigArgs;
...
public final class ClusterServicesEtcdDeprecatedArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterServicesEtcdDeprecatedArgs Empty = new ClusterServicesEtcdDeprecatedArgs();
    ...
    private @Nullable Output<ClusterServicesEtcdDeprecatedBackupConfigArgs> backupConfig;

    /**
     * @return Backup options for etcd service. For Rancher v2.2.x and above (list maxitems:1)
     * 
     */
    public Optional<Output<ClusterServicesEtcdDeprecatedBackupConfigArgs>> backupConfig() {
    ...
    /**
     * @return Snapshot option for etcd service. Default `true` (bool)
     * 
     */
    ...
    private ClusterServicesEtcdDeprecatedArgs() {}

    private ClusterServicesEtcdDeprecatedArgs(ClusterServicesEtcdDeprecatedArgs $) {
    ...
    public static Builder builder(ClusterServicesEtcdDeprecatedArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterServicesEtcdDeprecatedArgs();
        }

        public Builder(ClusterServicesEtcdDeprecatedArgs defaults) {
            $ = new ClusterServicesEtcdDeprecatedArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param backupConfig Backup options for etcd service. For Rancher v2.2.x and above (list maxitems:1)
         * 
         * @return builder
         * 
         */
        public Builder backupConfig(@Nullable Output<ClusterServicesEtcdDeprecatedBackupConfigArgs> backupConfig) {
         ...
         * 
         */
        public Builder backupConfig(ClusterServicesEtcdDeprecatedBackupConfigArgs backupConfig) {
        ...
        /**
         * @param snapshot Snapshot option for etcd service. Default `true` (bool)
         * 
         * @return builder
         * 
         */
        ...
        public ClusterServicesEtcdDeprecatedArgs build() {
            return $;
        }
    }
