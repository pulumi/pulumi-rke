...
@CustomType
public final class ClusterServicesEtcdBackupConfigS3BackupConfig {
    /**
    ...
    public static Builder builder(ClusterServicesEtcdBackupConfigS3BackupConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String secretKey;
        public Builder() {}
        public Builder(ClusterServicesEtcdBackupConfigS3BackupConfig defaults) {
        ...
        public ClusterServicesEtcdBackupConfigS3BackupConfig build() {
            final var _resultValue = new ClusterServicesEtcdBackupConfigS3BackupConfig();
