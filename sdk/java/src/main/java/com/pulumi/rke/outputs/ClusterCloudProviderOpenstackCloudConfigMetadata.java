...
@CustomType
public final class ClusterCloudProviderOpenstackCloudConfigMetadata {
    /**
     * @return (int)
     * 
     */
    ...
    public static Builder builder(ClusterCloudProviderOpenstackCloudConfigMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchOrder;
        public Builder() {}
        public Builder(ClusterCloudProviderOpenstackCloudConfigMetadata defaults) {
