...
import com.pulumi.rke.outputs.ClusterServicesEtcdBackupConfig;
...
@CustomType
public final class ClusterServicesEtcd {
    /**
     * @return Backup options for etcd service. For Rancher v2.2.x and above (list maxitems:1)
     * 
     */
    private @Nullable ClusterServicesEtcdBackupConfig backupConfig;
    /**
     ...
     * 
     */
    public Optional<ClusterServicesEtcdBackupConfig> backupConfig() {
    ...
    public static Builder builder(ClusterServicesEtcd defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer uid;
        public Builder() {}
        public Builder(ClusterServicesEtcd defaults) {
        ...
        @CustomType.Setter
        public Builder backupConfig(@Nullable ClusterServicesEtcdBackupConfig backupConfig) {
        ...
        public ClusterServicesEtcd build() {
            final var _resultValue = new ClusterServicesEtcd();
