...
import com.pulumi.rke.inputs.ClusterServicesEtcdBackupConfigS3BackupConfigArgs;
...
public final class ClusterServicesEtcdBackupConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterServicesEtcdBackupConfigArgs Empty = new ClusterServicesEtcdBackupConfigArgs();
    ...
    private @Nullable Output<ClusterServicesEtcdBackupConfigS3BackupConfigArgs> s3BackupConfig;

    /**
     * @return S3 config options for etcd backup (list maxitems:1)
     * 
     */
    public Optional<Output<ClusterServicesEtcdBackupConfigS3BackupConfigArgs>> s3BackupConfig() {
    ...
    private ClusterServicesEtcdBackupConfigArgs() {}

    private ClusterServicesEtcdBackupConfigArgs(ClusterServicesEtcdBackupConfigArgs $) {
    ...
    public static Builder builder(ClusterServicesEtcdBackupConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterServicesEtcdBackupConfigArgs();
        }

        public Builder(ClusterServicesEtcdBackupConfigArgs defaults) {
            $ = new ClusterServicesEtcdBackupConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder s3BackupConfig(@Nullable Output<ClusterServicesEtcdBackupConfigS3BackupConfigArgs> s3BackupConfig) {
         ...
         * 
         */
        public Builder s3BackupConfig(ClusterServicesEtcdBackupConfigS3BackupConfigArgs s3BackupConfig) {
        ...
        public ClusterServicesEtcdBackupConfigArgs build() {
            return $;
        }
    }
