...
public final class ClusterCloudProviderAwsCloudConfigServiceOverrideArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterCloudProviderAwsCloudConfigServiceOverrideArgs() {}

    private ClusterCloudProviderAwsCloudConfigServiceOverrideArgs(ClusterCloudProviderAwsCloudConfigServiceOverrideArgs $) {
        this.key = $.key;
        this.region = $.region;
    ...
    public static Builder builder(ClusterCloudProviderAwsCloudConfigServiceOverrideArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterCloudProviderAwsCloudConfigServiceOverrideArgs();
        }

        public Builder(ClusterCloudProviderAwsCloudConfigServiceOverrideArgs defaults) {
            $ = new ClusterCloudProviderAwsCloudConfigServiceOverrideArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterCloudProviderAwsCloudConfigServiceOverrideArgs build() {
            if ($.service == null) {
                throw new MissingRequiredPropertyException("ClusterCloudProviderAwsCloudConfigServiceOverrideArgs", "service");
            }
            return $;
        }
    }
