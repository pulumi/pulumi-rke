...
public final class ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs Empty = new ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs();
    ...
    private ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs() {}

    private ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs(ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs $) {
    ...
    public static Builder builder(ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs();
        }

        public Builder(ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs defaults) {
            $ = new ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterCloudProviderOpenstackCloudProviderBlockStorageArgs build() {
            return $;
        }
    }
