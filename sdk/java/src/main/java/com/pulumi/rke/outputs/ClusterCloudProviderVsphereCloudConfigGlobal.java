...
@CustomType
public final class ClusterCloudProviderVsphereCloudConfigGlobal {
    /**
     * @return (string)
     * 
     */
    ...
    public static Builder builder(ClusterCloudProviderVsphereCloudConfigGlobal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String workingDir;
        public Builder() {}
        public Builder(ClusterCloudProviderVsphereCloudConfigGlobal defaults) {
