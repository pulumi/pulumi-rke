...
public final class ClusterCloudProviderVsphereCloudProviderVirtualCenter {
    ...
    public static Builder builder(ClusterCloudProviderVsphereCloudProviderVirtualCenter defaults) {
    ...
    public static final class Builder {
        ...
        private String user;
        public Builder() {}
        public Builder(ClusterCloudProviderVsphereCloudProviderVirtualCenter defaults) {
        ...
        public Builder datacenters(String datacenters) {
            if (datacenters == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudProviderVirtualCenter", "datacenters");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudProviderVirtualCenter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudProviderVirtualCenter", "password");
            }
        ...
        public Builder user(String user) {
            if (user == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudProviderVirtualCenter", "user");
            }
            this.user = user;
            return this;
        }
        public ClusterCloudProviderVsphereCloudProviderVirtualCenter build() {
            final var _resultValue = new ClusterCloudProviderVsphereCloudProviderVirtualCenter();
