...
@CustomType
public final class ClusterServicesKubeProxyDeprecated {
    /**
    ...
    public static Builder builder(ClusterServicesKubeProxyDeprecated defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String image;
        public Builder() {}
        public Builder(ClusterServicesKubeProxyDeprecated defaults) {
        ...
        public ClusterServicesKubeProxyDeprecated build() {
            final var _resultValue = new ClusterServicesKubeProxyDeprecated();
