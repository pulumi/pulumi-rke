...
public final class ClusterCloudProviderOpenstackCloudProviderBlockStorage {
    ...
    public static Builder builder(ClusterCloudProviderOpenstackCloudProviderBlockStorage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean trustDevicePath;
        public Builder() {}
        public Builder(ClusterCloudProviderOpenstackCloudProviderBlockStorage defaults) {
        ...
        public ClusterCloudProviderOpenstackCloudProviderBlockStorage build() {
            final var _resultValue = new ClusterCloudProviderOpenstackCloudProviderBlockStorage();
