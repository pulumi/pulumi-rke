...
@CustomType
public final class ClusterServicesKubeControllerDeprecated {
    /**
    ...
    public static Builder builder(ClusterServicesKubeControllerDeprecated defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String serviceClusterIpRange;
        public Builder() {}
        public Builder(ClusterServicesKubeControllerDeprecated defaults) {
        ...
        public ClusterServicesKubeControllerDeprecated build() {
            final var _resultValue = new ClusterServicesKubeControllerDeprecated();
