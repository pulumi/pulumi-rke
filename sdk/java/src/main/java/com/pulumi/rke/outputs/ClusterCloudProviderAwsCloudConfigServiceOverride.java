...
@CustomType
public final class ClusterCloudProviderAwsCloudConfigServiceOverride {
    /**
     * @deprecated
     * Use service instead
     * 
    ...
    public static Builder builder(ClusterCloudProviderAwsCloudConfigServiceOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(ClusterCloudProviderAwsCloudConfigServiceOverride defaults) {
        ...
        public Builder service(String service) {
            if (service == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderAwsCloudConfigServiceOverride", "service");
            }
