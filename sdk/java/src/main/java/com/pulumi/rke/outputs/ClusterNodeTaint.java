...
public final class ClusterNodeTaint {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("ClusterNodeTaint", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("ClusterNodeTaint", "value");
            }
            this.value = value;
            return this;
        }
        public ClusterNodeTaint build() {
            final var _resultValue = new ClusterNodeTaint();
