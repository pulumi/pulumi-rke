...
public final class ClusterCloudProviderVsphereCloudConfigVirtualCenter {
    ...
    public static final class Builder {
        ...
        public Builder datacenters(String datacenters) {
            if (datacenters == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudConfigVirtualCenter", "datacenters");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudConfigVirtualCenter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudConfigVirtualCenter", "password");
            }
        ...
        public Builder user(String user) {
            if (user == null) {
              throw new MissingRequiredPropertyException("ClusterCloudProviderVsphereCloudConfigVirtualCenter", "user");
            }
            this.user = user;
            return this;
        }
